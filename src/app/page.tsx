          ...
          <div className="divide-y divide-[#BFA060]/15">
            {beers.map((beer) => (
              <div key={beer.name} className="flex items-center justify-between py-4 gap-4">
                <p className="text-[#BFA060] font-black text-sm sm:text-lg tracking-wide" style={{ textShadow: "0 0 25px rgba(191,160,96,0.20), 0 0 8px rgba(191,160,96,0.10)" }}>{beer.name}</p>
