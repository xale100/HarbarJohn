...
export default async function Home() {
  ...
  return (
    <div className="bg-[#080d08] text-[#DDD8CC]">
      ...
      {/* UPCOMING SHOWS */}
      <section className="grain py-10 sm:py-14 px-4 border-t-2 border-[#BFA060]/50" style={{ background: "linear-gradient(to bottom, #080d08 0%, #1a3a1a 30%, #0f170f 65%, #0f170f 100%)" }}>
