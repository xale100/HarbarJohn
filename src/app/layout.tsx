  ...
  return (
    <html lang="en" className={`${geistSans.variable} ${geistMono.variable}`}>
      <body className="antialiased">
        <div className="fixed top-0 left-0 bottom-0 w-px bg-[#BFA060]/25 z-40 pointer-events-none" />
        <div className="fixed top-0 right-0 bottom-0 w-px bg-[#BFA060]/25 z-40 pointer-events-none" />
        <Nav />
